...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Moduls engine1 = (StandartEngine) factory.createModule(ModulsType.STANDART_ENGINE, 50, 100, engine1_info);
        ...
        Moduls living_module1 = factory.createModule(ModulsType.LIVIND_MODULE, 13, 15);

        Moduls landing_module1 = factory.createModule(ModulsType.LANDING_MODULE, 10, 20);
        ...
        Moduls weapon1 = factory.createModule(ModulsType.ARMAMENT, 7, 1000, weapon1_info);
        ...
        Frame frame = new Frame(50, 5, 100, 9);
