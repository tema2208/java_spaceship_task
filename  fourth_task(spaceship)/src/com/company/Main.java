...
public class Main {
    ...
    ResearhSpaceshipBuilder builder = new ResearhSpaceshipBuilder();
    Spaceship spaceship = builder.setFactory(factory).setHullSize(5).setEngineSize(15).setSpaceshipType(SpaceshipType.RESEARCH).setRadarCount(3).build();
